...
EXPECTED_NOTEBOOK_SHA256 = (
    "0ca7f849ef37f43496cf8f6f6e12d3cfa4cb28b3e53fe1ddd79336dec3c76c97"
)
EXPECTED_BASE_COMMIT = "37b560837f981c225a15ee8842543349345fc4f8"
EXPECTED_BRANCH = "phase2/inference-protocol"
EXPECTED_CANARY_REF = "phase2-canary-v1"
EXPECTED_MODEL_KEYS = (
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--notebook",
        type=Path,
        default=Path("notebooks/phase2_colab_canary_v1.ipynb"),
...
def validate_notebook(notebook_path: Path, validator_path: Path) -> dict[str, Any]:
    ...
    require(
        'CANARY_GIT_REF = "phase2-canary-v1"' in joined_source,
    ...
    require(
        colab.get("name") == "phase2_colab_canary_v1.ipynb",
    ...
    report = {
        "artifact_name": "phase2_colab_canary_notebook_validation_v1",
        ...
        "notebook": {
            ...
            "path": "notebooks/phase2_colab_canary_v1.ipynb",
        ...
        "validator": {
            "path": "scripts/validate_phase2_colab_notebook.py",
